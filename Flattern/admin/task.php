...
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			<form method="POST" action="ex.php">	<b>																		
<?php
				...
				{
					echo "welcome Admin -   ".$_SESSION['idadmin'];
				}
				  else
				{
					header("http://localhost/elearning/Flattern/admin/adminlogin.php");
				} 
				
				echo "</b><html><div></html>";
		 ...
		 //$_SESSION['em']=$tempemail;
							...
							<table class='table table-message'>
									<tbody>
										...
										?>
										 <input type="text" value="<?php echo $row['id_msg']; ?>" name='R' > 
							...
							echo "<input class='due' name='reply' type='submit' value='Reply'>
							</input></b>							
							<b class='due'>
...
?>	
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">Admin - elearning </b>
		</div>
	</div>
