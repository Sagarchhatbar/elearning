...
<ul class="accordion" id="sizelist">
  <li>
    <a class="toggle"> 1. History of C++</a>
    <ul  class="inner">
      <li data-value="A Basic History of C++"  ><a href="" name="ht_java" value="History of java">A Basic History of C++</a></li>
      <li data-value="introduction to cpp"><a  href="videolist.php">introduction to cpp</a></li>
   

   <li data-value="The History of programming"><a href="videolist.php">The History of programming</a></li>
    <li data-value="How to Compile and Run a C++ Program"><a href="videolist.php">How to Compile and Run a C++ Program</a></li>
    <li data-value="Arithmetic Operators in c++"><a href="videolist.php">Arithmetic Operators in c++</a></li>
    </ul> 
  </li>
   <li>
...
<input id="sizevalue" size="50" name="size" type="text" style="display:none;" />
            ...
            <aside class="right-sidebar">
              <div class="widget">
                ...
                <ul class="folio-detail">
                  <li><label>Subject :</label>C++ language</li>
